 ...
 * своё фото. Фото берутся из поля product.images[] (массив URL).
 *
 * Чтобы добавить доп. фото для товара:
 *   1. Положите файлы в /public/images/products/product_{id}/
 *   2. Запустите: npm run sync-images  (или это произойдёт автоматически при npm run build)
 *
 * Файл products.json обновляется скриптом scripts/sync-product-images.js
 */
